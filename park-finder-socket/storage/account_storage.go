...
import (
	...
	"gitlab.comparking-finderpark-finder-socket/models"
...
func (cs AccoutStorage) FindAccountByID(id string) error {
...
func (cs AccoutStorage) FindAccountByProviderID(id string) error {
	ctx := context.Background()
