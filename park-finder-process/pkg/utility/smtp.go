...
func SendMailVerify(receiverEmail string, userType string, username string, password string, smtpServer string, smtpPort string) {
	fmt.Println("send mail OTP..")
	senderEmail := "easy.park.finder@gmail.com"
                ...
                <div style="width: 650px; 
                    ...
                    <div style="text-align: center; ">
                        ...
                        <div style="margin-top: 30px;  ">
							<a href="http://35.240.149.20:5009/` + userType + `/verify_email/` + receiverEmail + `" target="_blank" style="
